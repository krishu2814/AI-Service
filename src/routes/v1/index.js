...
const { AuthenticUser, OptionalAuth } = require("../../middleware/authentication");
...
// Phase 4: Shopping Agent & Session Memory (public/guest supported)
router.post("/agent/chat", OptionalAuth, aiController.agentChat.bind(aiController));
